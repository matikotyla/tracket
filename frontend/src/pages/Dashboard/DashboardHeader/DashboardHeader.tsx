  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.menu}>
        ...
        <div className="sm:ml-4 max-w-sm">
          ...
          <div className="flex rounded-md shadow-sm">
            <div className="relative flex-grow focus-within:z-10">
              ...
              <input
                ...
                className="w-full rounded-none rounded-l-md border-gray-300 pl-10 focus:border-teal-500 focus:ring-teal-500 block text-sm"
