    ...
    <div className={styles.root}>
      <div className={styles.container}>
        <div className={styles.header}>
          <h1>
            <span className={styles.headerSubtitle}>About</span>
            <span className={styles.headerTitle}>What makes us different</span>
          </h1>
...
export default withAnimation(About, CommonAnimations.page);
